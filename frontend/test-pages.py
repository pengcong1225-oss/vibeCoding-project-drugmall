...
PAGES = [
    {
        "name": "首页",
        "path": "/home",
        "selectors": [".home-page", ".banner", ".service-area", ".drug-list"],
        "description": "Banner、Tab切换、服务区域、瀑布流"
    },
    {
        "name": "药品详情页",
        "path": "/drug/1",
        "selectors": [".drug-detail", ".drug-info", ".price-section"],
        "description": "商品信息展示"
    },
    {
        "name": "购物车",
        "path": "/cart",
        "selectors": [".cart-page", ".cart-list", ".cart-footer"],
        "description": "购物车功能"
    },
    {
        "name": "订单确认",
        "path": "/order/confirm",
        "selectors": [".order-confirm", ".address-section", ".drug-list"],
        "description": "订单流程"
    },
    {
        "name": "订单列表",
        "path": "/order/list",
        "selectors": [".order-list", ".order-tabs", ".order-item"],
        "description": "订单状态"
    },
    {
        "name": "个人中心",
        "path": "/user",
        "selectors": [".user-page", ".user-header", ".menu-list"],
        "description": "用户信息"
    },
    {
        "name": "搜索页",
        "path": "/search",
        "selectors": [".search-page", ".search-input", ".search-history"],
        "description": "搜索功能"
    },
    {
        "name": "分类页",
        "path": "/category",
        "selectors": [".category-page", ".category-sidebar", ".category-content"],
        "description": "分类展示"
    },
    {
        "name": "药店详情",
        "path": "/store/1",
        "selectors": [".store-detail", ".store-header", ".drug-list"],
        "description": "药店信息"
    },
    {
        "name": "问诊页",
        "path": "/inquiry",
        "selectors": [".inquiry-page", ".doctor-list", ".symptom-tags"],
        "description": "问诊入口"
    },
    {
        "name": "地址管理",
        "path": "/address",
        "selectors": [".address-list", ".address-item"],
        "description": "地址功能"
    }
]
...
def test_page(page, page_info, screenshot_dir):
    ...
    try:
        ...
        # 获取控制台错误
        console_logs = page.evaluate("() => { return window.consoleErrors || []; }")
        if console_logs:
            result["console_errors"] = console_logs
            log(f"  控制台错误: {len(console_logs)}个", "WARN")
        
        # 截图
        screenshot_name = f"{page_info['name'].replace('/', '_')}.png"
